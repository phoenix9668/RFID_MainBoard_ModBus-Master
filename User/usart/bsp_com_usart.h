...
#define COM2_USART_BAUDRATE             	9600  //串口波特率
...
#define RS485_DIR1_PIN										GPIO_Pin_13
#define	RS485_DIR1_PORT       						GPIOD
#define	RS485_DIR1_CLK        						RCC_AHB1Periph_GPIOD

#define RS485_DIR1_OFF()   								GPIO_ResetBits(RS485_DIR1_PORT,RS485_DIR1_PIN)        
#define RS485_DIR1_ON()    								GPIO_SetBits(RS485_DIR1_PORT,RS485_DIR1_PIN)
#define RS485_DIR1_TOG()   								GPIO_ToggleBits(RS485_DIR1_PORT,RS485_DIR1_PIN)
/************************************************************/
